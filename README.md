# Material React Recipe search

Recipes are being fetched from the [foodfork](https://food2fork.com/about/api) Api.

Project uses the [Material-UI Framework](https://material-ui.com/).
...
<details>
<summary>Bootstraped with Create-react-app</summary>
